...
function handleArrowKeyRad1(event) {
    ...
    if (event.key === 'ArrowUp' && currentRadIndex > 0) {
        currentRadIndex -= 1;
    ...
    } else if (event.key === 'ArrowLeft' && currentRadIndex >= numCols) {
        currentRadIndex -= numCols;
    } else if (event.key === 'ArrowRight' && currentRadIndex < radios.length - numCols) {
        currentRadIndex += numCols;
    }
...
function handleArrowKeyRad2(event) {
    ...
    if (event.key === 'ArrowUp' && currentRadIndex2 > 0) {
        currentRadIndex2 -= 1;
    } else if (event.key === 'ArrowDown' && currentRadIndex2 < radios2.length - 1) {
        currentRadIndex2 += 1;
    } else if (event.key === 'ArrowLeft' && currentRadIndex2 >= numCols) {
        currentRadIndex2 -= numCols;
    } else if (event.key === 'ArrowRight' && currentRadIndex2 < radios2.length - numCols) {
        currentRadIndex2 += numCols;
    }
